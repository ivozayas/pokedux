...
const initialState = {
    ...
    emptySearch: false,
    typesColors: {
        grass: 'linear-gradient(180deg, rgba(15,120,69,1) 0%, rgba(60,222,58,1) 100%)',
        ...
        ice: 'linear-gradient(180deg, rgba(27,151,221,1) 0%, rgba(212,242,245,1) 100%)',
        ...
        dragon: ' linear-gradient(180deg, rgba(205,0,152,1) 0%, rgba(255,192,18,1) 100%)',
